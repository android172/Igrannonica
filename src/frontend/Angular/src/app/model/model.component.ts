...
import { localhost, tokenGetter } from '../app.module';
...
export class ModelComponent implements OnInit {
  ...
  posaljiZahtev(data:number){
    ...
    this.http.get(localhost+"Eksperiment/Podesavanja/"+data).subscribe(
      res=>{
        console.log(res);
        this.json1=res;
  ...
  this.http.get(localhost+"Eksperiment/Model/Naziv/"+ id, {responseType: 'text'}).subscribe(
      res=>{
        console.log(res);
  ...
  uzmiKolone()
  {
    ...
    this.http.get(localhost+"Eksperiment/Podesavanja/Kolone?id=" + this.idModela).subscribe(
        res=>{
  ...
  uzmiCekirane(){
    ...
    this.http.post(localhost+"Eksperiment/Podesavanja/Kolone?id="+this.idModela,{ulazne,izlazne}).subscribe(
      res=>{
        console.log(res);
      }
    );
  ...
  izmeniPodesavanja(){
    ...
    this.http.put(localhost+"Eksperiment/Podesavanja?id=" + this.idModela,jsonPod).subscribe(
      res=>{
  ...
  proveriM(){
    ...
    this.http.put(localhost+"Eksperiment/Modeli?ime=" + nazivE + "&id=" + this.idModela +"&ideksperimenta=" + this.idEksperimenta, {responseType : "text"}).subscribe(
      res=>{
  ...
  treniraj(){
    ...
    this.chart?.update();
    this.http.get(localhost+"Eksperiment/Model/Treniraj?id="+this.idModela,{responseType:"text"}).subscribe(
      res => {
        this.signalR.LossListener();
      //   setTimeout(() => {
      //     this.chart?.update();
