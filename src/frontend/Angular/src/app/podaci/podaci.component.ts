...
export class PodaciComponent implements OnInit {
  ...
  ucitanipodaci(){
    this.http.get(localhost+"Eksperiment/Eksperiment/Csv?id="+this.idEksperimenta,{responseType:"text"}).subscribe(
      res=>{
        console.log(res);
        this.fileName=res;
  ...
  onFileSelected(event:any) 
  {
    ...
    if (file) 
    {
      ...
      const upload$ = this.http.post(localhost+"Upload/upload/" + this.idEksperimenta , formData, {responseType: 'text'}).subscribe(
        res=>{
          this.loadDefaultItemsPerPage();
          (<HTMLDivElement>document.getElementById("poruka")).className="visible-y";  
          (<HTMLDivElement>document.getElementById("porukaGreske")).className="nonvisible-n";  
  ...
  {      
    this.http.get(localhost+"Upload/paging/1/10").subscribe(
       (response: any) => {
  ...
  onFileSelectedTest(event:any){
    ...
    if(filetest)
    {
      ...
      const upload$ = this.http.post(localhost+"Upload/uploadTest/" + this.idEksperimenta , formData, {responseType: 'text'}).subscribe(
        res=>{
  ...
  dajStatistiku()
  {
    this.http.get(localhost+"Upload/statistika", {responseType: 'text'}).subscribe(
      (response: any) => {
  ...
  promeniBrojRedova(value: any)
  {
    ...
    this.http.get(localhost+"Upload/paging/1/" + this.itemsPerPage).subscribe(
      (response: any) => {
        this.json =  JSON.parse(response.data);
        this.totalItems = response.totalItems;
        this.page = 1;
  ...
  gty(page: any){
   ...
   this.http.get(localhost+"Upload/paging/" + page + "/" + this.itemsPerPage).subscribe(
      (response: any) => {
        this.json =  JSON.parse(response.data);
        this.totalItems = response.totalItems;
    })
  ...
  { 
    ...
    this.http.post(localhost+"Upload/oneHotEncoding",this.selectedColumns,{responseType: 'text'}).subscribe(
      res => {
        console.log(res);
  ...
  { 
    ...
    this.http.post(localhost+"Upload/labelEncoding",this.selectedColumns,{responseType: 'text'}).subscribe(
      res => {
        console.log(res);
        this.selectedColumns = [];
        this.loadDefaultItemsPerPage();
  ...
  setRatio()
  {
    ...
    this.http.post(localhost+"Upload/setRatio/"+ratio,ratio,{responseType: 'text'}).subscribe(
      res => {
        console.log(res);
  ...
  deleteColumns()
  {
    this.http.post(localhost+"Upload/deleteColumns",this.selectedColumns,{responseType: 'text'}).subscribe(
      res => {
        console.log(res);
        this.loadDefaultItemsPerPage();
        this.selectedColumns = [];
  ...
  fillWithMean()
  {
    this.http.post(localhost+"Upload/fillWithMean",this.selectedColumns,{responseType: 'text'}).subscribe(
      res => {
        console.log(res);
        this.loadDefaultItemsPerPage();
        this.selectedColumns = [];
  ...
  fillWithMedian()
  {
    this.http.post(localhost+"Upload/fillWithMedian",this.selectedColumns,{responseType: 'text'}).subscribe(
      res => {
        console.log(res);
        this.loadDefaultItemsPerPage();
        this.selectedColumns = [];
  ...
  fillWithMode()
  {
    this.http.post(localhost+"Upload/fillWithMode",this.selectedColumns,{responseType: 'text'}).subscribe(
      res => {
        console.log(res);
        this.loadDefaultItemsPerPage();
        this.selectedColumns = [];
  ...
  replaceEmptyWithNA()
  {
    this.http.post(localhost+"Upload/replaceEmpty",this.selectedColumns,{responseType: 'text'}).subscribe(
      res => {
        console.log(res);
        this.loadDefaultItemsPerPage();
        this.selectedColumns = [];
  ...
  replaceZeroWithNA(){
    ...
    this.http.post(localhost+"Upload/replaceZero",this.selectedColumns,{responseType: 'text'}).subscribe(
      res => {
        console.log(res);
        this.loadDefaultItemsPerPage();
        this.selectedColumns = [];
  ...
  deleteRows()
  {
    ...
    this.http.post(localhost+"Upload/deleteRows",redoviZaBrisanje,{responseType: 'text'}).subscribe(
      res => {
  ...
  ucitajNaziv()
  {
    this.http.get(localhost+'Eksperiment/Eksperiment/Naziv/' + this.idEksperimenta, {responseType: 'text'}).subscribe(
        res=>{
          console.log(res);
  ...
  proveriE(){
      ...
      //}
      this.http.put(localhost+"Eksperiment/Eksperiment?ime=" + nazivE + "&id=" + this.idEksperimenta, {responseType : "text"}).subscribe(
        res=>{
...
/*
    ...
    this.http.put(localhost+"Upload/updateValue/" + row + "/" + column + "/" + data.value,null, {responseType: 'text'}).subscribe(
      res => {
        console.log(res);
        //this.loadDefaultItemsPerPage();
        this.selectedColumns = [];
