...
export class ModeliComponent implements OnInit {
  ...
  napraviModel(){
    ...
    this.http.post(localhost+"Eksperiment/Modeli?ime=" + ime + "&id=" + this.id,null,{responseType: 'text'}).subscribe(
      res=>{
        console.log(res);
        this.ucitajModel();
  ...
  ucitajModel()
  {
    ...
    this.http.get(localhost+'Eksperiment/Modeli/' + this.id).subscribe(
        res=>{
          console.log(res);
          this.json = res;
  ...
  ucitajImeE(){
    this.http.get(localhost+'Eksperiment/Eksperiment/Naziv/' + this.id,{responseType: 'text'}).subscribe(
        res=>{
  ...
  obrisiModel(i:any)
  {
    ...
    {
      this.http.delete(localhost+'Eksperiment/Modeli/' + i,{responseType: 'text'}).subscribe(
       res=>{
         console.log(res);
            this.ucitajModel();
